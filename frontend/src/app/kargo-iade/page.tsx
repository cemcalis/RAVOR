        ...
        <section className="mb-12">
          ...
          <div className="space-y-6">
            <div className="bg-muted p-6 rounded-lg">
              ...
              <ul className="space-y-2 text-foreground/70">
                <li>
                  ...
                  <strong className="text-green-600">ücretsiz kargo</strong>
                </li>
                <li>
                  • 2.000 TL altı alışverişlerde kargo ücreti:{" "}
                  <strong>49,90 TL</strong>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-muted p-6 rounded-lg">
              ...
              <ul className="space-y-2 text-foreground/70">
                <li>
                  • Siparişiniz onaylandıktan sonra <strong>1-2 iş günü</strong>{" "}
                  içinde kargoya verilir
                </li>
                <li>
                  • Kargo teslimat süresi: <strong>2-3 iş günü</strong>
                </li>
                <li>
                  • Toplam teslimat süresi: <strong>3-5 iş günü</strong>
                </li>
                <li>
                  • Hafta sonları ve resmi tatil günleri teslimat yapılmaz
                </li>
              </ul>
            </div>
            ...
            <div className="bg-accent/20 p-6 rounded-lg border-l-4 border-secondary">
              ...
              <p className="text-sm text-foreground/70">
                Siparişiniz kargoya verildikten sonra e-posta adresinize kargo
                takip numarası gönderilecektir. Bu numara ile kargo firmasının
                web sitesinden gönderinizi takip edebilirsiniz.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="space-y-6">
            <div className="bg-muted p-6 rounded-lg">
              ...
              <ul className="space-y-2 text-foreground/70">
                <li>
                  ...
                  <strong>14 gün</strong> içinde iade edebilirsiniz
                </li>
                <li>
                  • Ürün kullanılmamış, yıkanmamış ve etiketleri sökülmemiş
                  olmalıdır
                </li>
                <li>
                  • Hijyen gerekliliği olan ürünler (iç giyim, mayo, bikini){" "}
                  <strong>iade edilemez</strong>
                </li>
            ...
            <div className="bg-muted p-6 rounded-lg">
              ...
              <ol className="space-y-3 text-foreground/70">
                <li className="flex gap-3">
                  ...
                  <span>
                    İade talebinizi <strong>info@ravor.com</strong> adresine
                    veya müşteri hizmetlerimize iletin
                  </span>
                </li>
                <li className="flex gap-3">
                  <span className="font-semibold text-primary">2.</span>
                  <span>
                    Size iade kargo kodu gönderilecektir (iade kargo
                    ücretsizdir)
                  </span>
                </li>
                <li className="flex gap-3">
                ...
                <li className="flex gap-3">
                  ...
                  <span>
                    Ürün depomıza ulaştıktan sonra <strong>3-5 iş günü</strong>{" "}
                    içinde ödemeniz iade edilir
                  </span>
                </li>
              </ol>
            </div>
            ...
            <div className="bg-muted p-6 rounded-lg">
              ...
              <ul className="space-y-2 text-foreground/70">
                ...
                <li>
                  • Veya müşteri hizmetlerimizle iletişime geçin, size yardımcı
                  olalım
                </li>
              </ul>
            </div>
            ...
            <div className="bg-accent/20 p-6 rounded-lg border-l-4 border-secondary">
              ...
              <p className="text-sm text-foreground/70">
                İade onaylandıktan sonra ödemeniz, satın alma sırasında
                kullandığınız ödeme yöntemine (kredi kartı, banka kartı){" "}
                <strong>5-7 iş günü</strong> içinde iade edilir.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="space-y-4">
            <details className="bg-muted p-6 rounded-lg cursor-pointer">
              ...
              <p className="mt-3 text-foreground/70 text-sm">
                Siparişiniz kargoya verildikten sonra e-posta adresinize kargo
                takip numarası gönderilir. Bu numara ile kargo firmasının web
                sitesinden takip yapabilirsiniz.
              </p>
            </details>
            ...
            <details className="bg-muted p-6 rounded-lg cursor-pointer">
              ...
              <p className="mt-3 text-foreground/70 text-sm">
                İade kargo ücreti tarafımızca karşılanmaktadır. Size ücretsiz
            ...
            <details className="bg-muted p-6 rounded-lg cursor-pointer">
              ...
              <p className="mt-3 text-foreground/70 text-sm">
                Hijyen gerekliliği olan ürünler (iç giyim, mayo, bikini) ve
                kullanılmış, yıkanmış veya etiketi sökülmüş ürünler iade
                edilemez.
              </p>
            </details>
            ...
            <details className="bg-muted p-6 rounded-lg cursor-pointer">
              <summary className="font-semibold">
                İade param ne zaman hesabıma geçer?
              </summary>
              <p className="mt-3 text-foreground/70 text-sm">
                İade onaylandıktan sonra ödemeniz 5-7 iş günü içinde kredi
                kartınıza veya banka hesabınıza iade edilir. Bankanıza göre bu
            ...
            <details className="bg-muted p-6 rounded-lg cursor-pointer">
              <summary className="font-semibold">
                Yurtdışına kargo yapıyor musunuz?
              </summary>
              <p className="mt-3 text-foreground/70 text-sm">
                Şu anda sadece Türkiye içi teslimat yapıyoruz. Uluslararası
                kargo için info@ravor.com adresinden bizimle iletişime
                geçebilirsiniz.
              </p>
            </details>
          </div>
