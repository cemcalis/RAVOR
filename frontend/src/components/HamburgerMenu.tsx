...
export default function HamburgerMenu({ open, onClose, categories = [] }: any) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-gradient-to-br from-[rgba(251,241,238,0.80)] via-white/90 to-[rgba(247,215,200,0.80)] backdrop-blur-xl">
      <div className="container mx-auto px-6 py-8 h-full flex flex-col">
        <div className="flex items-center justify-between">
          ...
          <button
            onClick={onClose}
            className="p-2 text-champagne-contrast hover:bg-champagne-200 rounded-md transition-colors"
          >
            <FiX size={28} />
          </button>
        </div>
        ...
        <div className="py-6 border-t border-champagne-200">
          <div className="flex gap-4 text-champagne-contrast opacity-80">
            <a
              href="#"
              className="text-sm hover:opacity-100 hover:text-champagne-contrast transition-colors"
            >
              İletişim
            </a>
            <a
